...
@Setter
@Getter
public class ControllerCetakInvoiceCustomer extends CetakLaporan {
    ...
    public void downloadXLSLaporan(String customer) {
    ...
    private String jRXMLFileName = "daftarinvoice.jrxml";
