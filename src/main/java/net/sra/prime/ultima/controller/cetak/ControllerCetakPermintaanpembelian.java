...
@Setter
@Getter
public class ControllerCetakPermintaanpembelian extends CetakLaporan {
    ...
    private String jRXMLFileName = "permintaan_pembelian.jrxml";
    ...
    public Map getParameterAndValue() {
        ...
        try {
             BufferedImage check = ImageIO.read(resourceLoader.getResource("classpath:/static/img/check-mark.jpg").getInputStream());
