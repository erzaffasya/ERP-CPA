...
@Setter
@Getter
public class ControllerCetakPL extends CetakLaporan {
    ...
    public void inititem() {
            jRXMLFileName = "picking_list.jrxml";
    }
   ...
   // private String nomor = "06/002/SPH/CPA-DP/02000205/IX/2017";
    ...
    public Map getParameterAndValue() {
        ...
        try {
            ...
            param.put("logo", logo);
//            BufferedImage logocpa = ImageIO.read(resourceLoader.getResource("classpath:/static/img/cpalogo.jpg").getInputStream());
//            param.put("logocpa", logocpa);
