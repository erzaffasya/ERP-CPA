...
@Setter
@Getter
public class ControllerCetakListSo extends CetakLaporan {
    ...
    public void downloadXLSLaporan(String tgl_awal, String tgl_akhir, String status) {
    ...
    private String jRXMLFileName = "sales_order.jrxml";
