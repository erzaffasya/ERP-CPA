...
@Setter
@Getter
public class ControllerCetakTandaTerimaInvoice extends CetakLaporan {
    ...
    public void downloadXLSLaporan(Integer id) {
        this.id = id;
   ...
   // private String jRXMLFileName = "master-detail.jrxml";
    private String jRXMLFileName = "tanda_terima_invoice.jrxml";
    private Integer id;
