...
import net.sra.prime.ultima.service.hr.ServiceResign;
...
@Setter
@Getter
public class ControllerResign implements java.io.Serializable {

    private static final long serialVersionUID = 8811960521862002964L;

    @Autowired
    private ServiceResign serviceResign;
    private Resign item;
    private List<Resign> lResign = new ArrayList<>();
    ...
    public void onLoadList() {
        try {
            lResign = serviceResign.onLoadList();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    public List<Resign> getDataResign() {
        return lResign;
    }
