...
@Setter
@Getter
public class ControllerKendaraan implements java.io.Serializable {

    private static final long serialVersionUID = 8811960521862002964L;

    @Autowired
    private ServiceKendaraan serviceKendaraan;
    private Kendaraan item;
    private List<Kendaraan> lKendaraan = new ArrayList<>();
    ...
    public void onLoadList() {
        try {
            lKendaraan = serviceKendaraan.onLoadList();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }

    public List<Kendaraan> getDataKendaraan() {
        return lKendaraan;
    }
    ...
    public void onLoad() {
        item = serviceKendaraan.onLoad(item.getId());
    }
