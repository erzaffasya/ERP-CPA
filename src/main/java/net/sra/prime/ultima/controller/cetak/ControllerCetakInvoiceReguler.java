...
@Setter
@Getter
public class ControllerCetakInvoiceReguler extends CetakLaporan {
   ...
   // private String jRXMLFileName = "master-detail.jrxml";
    private String jRXMLFileName = "invoice_terbilang_reguler.jrxml";
    private String nomor;
  
    @Override
    public Map getParameterAndValue() {
        HashMap param = new HashMap();
        param.put("no_penjualan", nomor);
        try {
