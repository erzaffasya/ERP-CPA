...
@Setter
@Getter
public class ControllerCetakBottomPrice extends CetakLaporan {
    ...
    @PostConstruct
    public void awal() {
        System.err.println("Print Bottom Price");
    }

   // private String jRXMLFileName = "master-detail.jrxml";
    private String jRXMLFileName = "bottom_price.jrxml";
    private String gudang;
  
    @Override
    public Map getParameterAndValue() {
        HashMap param = new HashMap();
        param.put("gudang", gudang);
        param.put("nama_perusahaan", "PT. CAHAYA PENGAJARAN ABADI");
        return param;
    }
