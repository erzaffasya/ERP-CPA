...
@Setter
@Getter
public class ControllerCetakKasKeluar extends CetakLaporan {
    ...
    @PostConstruct
    public void awal() {
        System.err.println("Print Bukti Kas Keluar");
    }

   // private String jRXMLFileName = "master-detail.jrxml";
    private String jRXMLFileName = "bukti_kas_keluar.jrxml";
