...
@Setter
@Getter
public class ControllerCetakPaymentProposal extends CetakLaporan {
    ...
    @PostConstruct
    public void awal() {
        System.err.println("Print Payment Proposal");
    }

   // private String jRXMLFileName = "master-detail.jrxml";
    private String jRXMLFileName = "payment_proposal.jrxml";
