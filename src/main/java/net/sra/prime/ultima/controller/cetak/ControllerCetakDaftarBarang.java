...
@Setter
@Getter
public class ControllerCetakDaftarBarang extends CetakLaporan {
    ...
    @PostConstruct
    public void awal() {
        System.err.println("Print Form Stok Opname");
    }

   // private String jRXMLFileName = "master-detail.jrxml";
    private String jRXMLFileName = "daftarbarangso.jrxml";
