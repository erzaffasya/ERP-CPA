...
@Setter
@Getter
public class ControllerCetakPembayaranHutang extends CetakLaporan {
    ...
    @PostConstruct
    public void awal() {
        System.err.println("Print Pembayaran Hutang");
    }

   // private String jRXMLFileName = "master-detail.jrxml";
    private String jRXMLFileName = "pembayaran_ap.jrxml";
