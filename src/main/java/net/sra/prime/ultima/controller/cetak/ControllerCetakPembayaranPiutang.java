...
@Setter
@Getter
public class ControllerCetakPembayaranPiutang extends CetakLaporan {
    ...
    @PostConstruct
    public void awal() {
        System.err.println("Print Pembayaran Piutang");
    }

   // private String jRXMLFileName = "master-detail.jrxml";
    private String jRXMLFileName = "official_receipt.jrxml";
