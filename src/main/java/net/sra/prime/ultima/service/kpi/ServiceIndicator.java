...
import net.sra.prime.ultima.db.mapper.kpi.MapperIndicator;
...
public class ServiceIndicator {
    ...
    @Autowired
    MapperIndicator referensi;
    
    
    @Transactional(readOnly = true)
    public List<Indicator> onLoadList() {
    ...
    @Transactional(readOnly = false)
    public void tambah(Indicator item) {
            referensi.insert(item);
    }
    
    
    @Transactional(readOnly = false)
    public void ubah(Indicator item) {
        referensi.update(item);
    }

    @Transactional(readOnly = true)
    public Indicator onLoad(Integer id) {
