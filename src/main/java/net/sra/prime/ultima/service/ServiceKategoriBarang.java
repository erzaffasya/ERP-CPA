...
import net.sra.prime.ultima.db.mapper.MapperKategoriBarang;
...
public class ServiceKategoriBarang {
    ...
    @Autowired
    MapperKategoriBarang referensi;

    @Transactional(readOnly = true)
    public List<KategoriBarang> onLoadList() {
    ...
    @Transactional(readOnly = false)
    public void tambah(KategoriBarang item) {
