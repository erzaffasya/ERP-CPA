...
@Getter
@Setter
public class KantorConverter implements java.io.Serializable, Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        if (value != null && value.trim().length() > 0) {
            try {
                InternalKantorCabang internalKantorCabang = serviceKantor.onLoad(value);
                return internalKantorCabang;
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        if (object != null) {
            return String.valueOf(((InternalKantorCabang) object).getId_kantor_cabang());
        } else {
            return null;
        }
    }
