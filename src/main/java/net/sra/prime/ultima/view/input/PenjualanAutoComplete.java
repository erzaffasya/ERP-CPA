...
@Named("penjualanAutoComplete")
@ConversationScoped
@Getter
@Setter
public class PenjualanAutoComplete implements java.io.Serializable {
    ...
    @Produces
    public List<Penjualan> completePenjualanByCustomerContains(String query) {
        allPenjualan = servicePenjualan.selectPenjualanByCustomer(id_customer);
        List<Penjualan> filteredPos = new ArrayList<>();
