...
@Getter
@Setter
public class ProposalConverter implements java.io.Serializable, Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        if (value != null && value.trim().length() > 0) {
            try {
                AccProposalApDetail accProposalApDetail = servicePembayaranHutang.selectOneDetail(value);
                return accProposalApDetail;
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        if (object != null) {
            return String.valueOf(((AccProposalApDetail) object).getAp_number());
        } else {
            return null;
        }
    }
