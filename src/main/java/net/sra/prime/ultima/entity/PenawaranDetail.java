...
@Getter
@Setter
public class PenawaranDetail extends  Penawaran implements java.io.Serializable {
    ...
    private Boolean jenis_satuan;
    private Double additional_charge;
    private Double jml_invoice;
    private Double selisih;
    private Double jml_order;
}
