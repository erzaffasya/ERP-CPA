 ...
 * @author hairian
 */
public class ProviderKonsumsi {

    public static final String SELECT = "SELECT a.*, b.gudang FROM konsumsi a  "
            + " INNER JOIN gudang b ON a.id_gudang = b.gudang ";
    ...
    public String SelectAll(Map<String, Object> parameters) {
        ...
        if (id_gudang != null && !"".equals(id_gudang)) {
            Query.append(where).append("a.id_gudang=#{id_gudang} ");
            if (awal != null)
        ...
        Query.append(" ORDER BY a.tanggal DESC, a.id DESC");
