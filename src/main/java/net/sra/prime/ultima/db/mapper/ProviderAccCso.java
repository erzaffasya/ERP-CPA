 ...
 * @author hairian
 */
public class ProviderAccCso {

    public static final String SELECT = "SELECT a.*, b.nama as kantor FROM acc_cso a  "
    ...
    public String SelectAll(Map<String, Object> parameters) {
        ...
        Query.append(" ORDER BY a.acc_cso_number, a.tanggal DESC");
